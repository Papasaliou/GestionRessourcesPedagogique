    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link text-light"  aria-current="page" href="classe.php">Retour<span>></span></a>
                </li>
...
<div class="container pt-5">
      ...
      $requette="SELECT nom,prenom,annee,niveau FROM classe JOIN enseignant ON enseignant.IDEnseignant=classe.IDEnseignant;";
      $result=$conn->query($requette);
      echo'<div class="titreE pt-5">Liste Des Classe </div>
      <div  class="container-fluid">
          <div class="row">
              <div class="col-sm-12  " >
