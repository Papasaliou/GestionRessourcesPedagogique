...
<nav class="navbar fixed-top navbar-expand-lg text-light justify-content-center nav-justified" style="background-color:green;">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link text-light"  aria-current="page" href="Annonces.php">Retour<span>></span></a>
                </li>
    ...
    $requette="select nom,prenom,mots,DateAnnonce from annonces,classe,enseignant where annonces.IDEnseignant=classe.IDEnseignant and annonces.IDEnseignant=$identifiant and enseignant.IDEnseignant=classe.IDEnseignant  ORDER BY DateAnnonce DESC limit 10";
                      ...
                      while($ligne=$result->fetch())
                      {
                        echo'<div class="border-3">';
                          ...
                          <div class=" row card-body b">
                                <div class="col-lg-9">
                                    <p class="card-text text-light">'.$mots.'</p>
                                </div>
                                <div class="col-lg-3">
